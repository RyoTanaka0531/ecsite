...
class ItemsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        $item_seeds = [
            [
                'name' => 'ネスレ　スターバックス　ハウスブレンド　ネスカフェドルチェグスト専用カプセル',
                'amount' => '980',
            ],
            [
                'name' => 'キリン　午後の紅茶　美味しい無糖　2L PET×9本',
                'amount' => '1286',
            ],
            [
            ...
            [
                'name' => '【無糖】コカコーラ　い・ろ・は・す　天然水にれもん　555mlPET×24本',
                'amount' => '2143',
            ],
            [
            ...
            [
                'name' => '[2CS][トクホ]コカコーラ　からだすこやか茶W　お茶　ペットボトル(350ml×24本)×２箱',
                'amount' => '6131',
            ],
            [
                'name' => '[トクホ]コカコーラ　からだすこやか茶W　お茶　ペットボトル　350ml×24本',
                'amount' => '3066',
            ],
            [
